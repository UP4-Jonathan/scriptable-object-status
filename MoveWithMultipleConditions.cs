...
public class MoveWithMultipleConditions: MonoBehaviour
{ 
    //Refernce to out Character Stat Script
    [SerializeField] private MultipleCharacter character;
    ...
    void Update()
    {
        if(Utilities.CheckForTrue(character.moveChecks)) return;
